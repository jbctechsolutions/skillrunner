...
var rootCmd = &cobra.Command{
	...
	Long: `Skillrunner helps you execute structured AI-powered development tasks by converting
natural language requests into multi-step workflows that tools like Continue can execute.

This CLI is available as both 'skillrunner' and 'sr' (short alias).

Examples:
  skillrunner run code-review "Review this code for issues"
...
func init() {
	...
	runCmd.Flags().BoolVar(&forceCloud, "force-cloud", false, "Force cloud models (Anthropic)")
	...
	askCmd.Flags().BoolVar(&forceCloud, "force-cloud", false, "Force cloud models (Anthropic)")
