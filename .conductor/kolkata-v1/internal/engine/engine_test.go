...
func TestRunTestSkill(t *testing.T) {
	sr := NewSkillrunnerForTesting("/test", models.ResolvePolicyAuto, getTestSkillsDir())
...
func TestGetStatus(t *testing.T) {
	...
	sr := NewSkillrunnerForTesting("/workspace", models.ResolvePolicyAuto, getTestSkillsDir())
	setupTestProviders(sr)
...
func TestLoadSkillCaching(t *testing.T) {
	...
	// Load skill first time (will load from testdata fixtures)
...
func TestEnvelopeMetadata(t *testing.T) {
	sr := NewSkillrunnerForTesting("/test/workspace", models.ResolvePolicyAuto, getTestSkillsDir())
	setupTestProviders(sr)
	...
	if envelope.Metadata["workspace"] != "/test/workspace" {
		t.Error("Envelope should contain workspace metadata")
	}
