...
**Linear Epic:** [Create in Linear and add ID here]

---

## Linear Issue Reference

| Issue ID | Title | Estimate | Phase |
|----------|-------|----------|-------|
| MCP-1 | Server Management Commands | 3 points | CLI |
| MCP-2 | Tool Discovery Commands | 2 points | CLI |
| MCP-3 | Status Command Integration | 1 point | CLI |
| MCP-4 | Skill Domain Model Extension | 2 points | Integration |
| MCP-5 | Tool Permission System | 3 points | Integration |
| MCP-6 | Provider Tool Integration | 5 points | Integration |
| MCP-7 | Tool Call Streaming Display | 2 points | Integration |
| MCP-8 | Default Server Configurations | 2 points | Polish |
| MCP-9 | Example Skills | 2 points | Polish |
| MCP-10 | MCP Documentation | 2 points | Polish |
| MCP-11 | Integration Tests | 3 points | Testing |
| MCP-12 | v1.2.0 Release Preparation | 2 points | Release |

**Import Linear issues from:** `docs/v1.2.0-linear-issues.md`
...
**Current State:**
- ✅ MCP domain layer implemented (internal/domain/mcp/)
- ✅ MCP adapters implemented (internal/adapters/mcp/)
- ✅ Comprehensive test coverage (8 test files, 2000+ lines)
- ❌ No CLI commands to manage MCP servers
- ❌ Skills cannot declare tool requirements
...
MCP Servers:
  ...
  ✓ git            Running    8 tools available
  ✗ browser        Stopped    (not configured)
```
...
🔧 Calling tool: filesystem__read_file
   Arguments: {"path": "data.json"}
   ✓ Success (1.2 KB read)

Transforming the data...

🔧 Calling tool: filesystem__write_file
...
**Dependencies:**
- MCP-6 (tool calling must work first)
...
**Dependencies:**
- MCP-4 (skill tool syntax)
- MCP-6 (tool execution)
- MCP-8 (bundled servers)
...
**Linear Issue:** MCP-11 (Integration Tests)
...
**Linear Issue:** MCP-12 (Release Preparation)
